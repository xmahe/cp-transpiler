...
bash "${ROOT}/tests/run_inject_bind.sh"
bash "${ROOT}/tests/run_member_subobjects.sh"
bash "${ROOT}/tests/run_member_initializers.sh"
bash "${ROOT}/tests/run_member_initializer_overloads.sh"
